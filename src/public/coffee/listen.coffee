  ...
  element_: () ->
    @element = 
      ...
      add: () ->
        ...
        if state.element.add.text.min_length==false and inspector.element.add.text.min_length(obj)==false
          state.element.add.text.min_length = true
          
          _listner = () ->
            if inspector.element.add.text.min_length this
              this.removeEventListener 'keyup', _listner, false
              state.element.add.text.min_length = false
